...
def get_db_results(search_keyword: str, custom_keyword: str, pdf_min_page: str, min_word_count: str, num_years: str,
                   doc_type: str, page: str, tags: list, sort: str) -> dict:
    """
    ...
    try:
        existing_pdfs = mg.search_datas(search_keyword, pdf_min_page, min_word_count, num_years, doc_type, page, tags, sort)
