...
def search_db(search_keyword, min_words, pdf_min_num_page, num_years):
    ...
    return run_database.get_results(search_keyword, pdf_min_num_page, min_words, num_years)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        keyword = '雷克萨斯'
#    scrape(search_keyword=keyword, filter_keyword='', min_words='3000', pdf_min_num_page='150', num_years=1)
    res = search_db(search_keyword=keyword, min_words='3000', pdf_min_num_page='150', num_years=1)
    print(res)
